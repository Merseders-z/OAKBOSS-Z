...
import merchantAssetCopy from "../pages/merchantAssetCopy/merchantAsset";
...
export default new Router({
	routes: [{
		...
		//选择身份
		{
			path: "/loginChoose",
			name: "loginChoose",
			component: () => import("../pages/loginChoose.vue")
		},
		//设备监控
		{
			path: "/deviceManager",
		...
		//停车场订单详情
		{
			path: "/parkDDxiangqing",
			name: "parkDDxiangqing",
			component: () => import("../pages/parkDDxiangqing.vue"),
			children: [{
					path: "/parkjiben",
					name: "parkjiben",
					component: () => import("../pages/parkxiangqing/parkjiben.vue")
				},
				{
					path: "/parkXQ",
					name: "parkXQ",
					component: () => import("../pages/parkxiangqing/parkXQ.vue")
				},
				{
					path: "/parkTimeLine",
					name: "parkTimeLine",
					component: () => import("../pages/parkxiangqing/parkTimeLine.vue")
				}
			],
			redirect: "/parkjiben"
		},
		...
		//道路停车
		{
			...
			children: [{
				...
				},
				{
					path: "/kaoqing",
					name: "kaoqing",
					component: () => import("../pages/parksChild/kaoqing.vue")
				},
				{
					path: "/shoufeiyuan",
					name: "shoufeiyuan",
					component: () => import("../pages/parksChild/shoufeiyuan.vue")
				},
				{
					path: "/xunjianyuan",
					name: "xunjianyuan",
					component: () => import("../pages/parksChild/xunjianyuan.vue")
				},
				{
					path: "/jixiaobaobiao",
					name: "jixiaobaobiao",
		...
		//充电订单详情页
		{
			path: "/motoxiangqing",
			name: "motoxiangqing",
			component: () => import("../pages/motoxiangqing.vue"),
			children: [{
					path: "/motojiben",
					name: "motojiben",
					component: () => import("../pages/motodingdanxiangqing/motojiben.vue")
				},
				{
					path: "/motocd",
					name: "motocd",
					component: () => import("../pages/motodingdanxiangqing/motocd.vue")
				}
			],
			redirect: "/motojiben"
		},
		//停车场设备详情
		{
			path: "/carCharger",
			name: "carCharger",
			component: () => import("../pages/carCharger.vue"),
			children: [{
					path: "/carChargerJB",
					name: "carChargerJB",
					component: () => import("../components/carxq/carChargerJB.vue")
				},
				{
					path: "/carJBjilu",
					name: "carJBjilu",
					component: () => import("../components/carxq/carJBjilu.vue")
				},
				{
					path: "/carJS",
					name: "carJS",
					component: () => import("../components/carxq/carJS.vue")
				}
			],
			redirect: "/carChargerJB"
		},
		{
			path: "/chargersXi",
		...
		//电单车充电设备详情
		{
			...
			children: [{
				...
				},
				{
					path: "/canshu",
					name: "canshu",
					component: () => import("../components/zhandianAll/canshu.vue")
				},
				{
					path: "/chargerQx",
					name: "chargerQx",
					component: () => import("../components/zhandianAll/chargerQx.vue")
				},
				{
					path: "/chargerRz",
					name: "chargerRz",
					component: () => import("../components/zhandianAll/chargerRz.vue")
				}
			],
