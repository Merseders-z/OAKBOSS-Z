		...
		<div>
			<template>
				<el-table :data="cardList" stripe style="width: 100%">
					...
					<el-table-column prop="enter_time" label="驶入时间" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="leave_time" label="离场时间" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="duration" label="停车时长" show-overflow-tooltip>
	...
	export default {
		...
		methods: {
			...
			getUserMes() {
				...
				//console.log(toKen)
				this.$axios.get("admin/api/pdrs/service/22/state/2/?token=" + toKen + "&page=" + this.pagenum + "&row=14&keyword=" + this.input+"&from=" + this.startTime + "&to=" + this.endTime)
					.then(res => {
