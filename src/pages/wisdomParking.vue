		...
		<div class="UserAssets-left">
			...
			<el-col :span="12">
				<el-menu default-active="2" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose"
					background-color="#1e69fe" text-color="#fff" active-text-color="white" unique-opened
					v-model="option">
					<el-submenu index="1">
						<template slot="title">
							<div class="menu-op">
								<div>
									<img src="../assets/images/dataview.png" style="width: 18px;height: 18px;" />
								</div>
					...
					<el-submenu index="2">
						<template slot="title">
							<div class="menu-op">
								<div>
									<img src="../assets/images/Resourcemanagement.png" style="width: 18px;height: 18px;"/>
								</div>
					...
					<el-submenu index="3">
						<template slot="title">
							<div class="menu-op">
								<div>
									<img src="../assets/images/Chargemanagement.png" style="width: 18px;height: 18px;"/>
								</div>
								<span class="menu-word">收费管理</span>
							</div>
						</template>
						<el-menu-item-group>
							<el-menu-item index="3-1">
								<router-link to="/shoufeiyuan">
									<div class="menu-op">
										<div>
											<img src="../assets/images/Prepaid plan.png" />
										</div>
										<span class="menu-word">收费员</span>
									</div>
								</router-link>
							</el-menu-item>
							<el-menu-item index="3-2">
								<router-link to="/xunjianyuan">
									<div class="menu-op">
										<div>
											<img src="../assets/images/Monthly package.png" />
										</div>
										<span class="menu-word">巡检员</span>
									</div>
								</router-link>
							</el-menu-item>
							<el-menu-item index="3-3">
								<router-link to="/paiban">
									<div class="menu-op">
										...
										<span class="menu-word">排班</span>
									</div>
								</router-link>
							</el-menu-item>
							<el-menu-item index="3-4">
								<router-link to="/kaoqing">
									<div class="menu-op">
										<div>
											<img src="../assets/images/Monthly package.png" />
										</div>
										<span class="menu-word">考勤</span>
									</div>
								</router-link>
							</el-menu-item>
						</el-menu-item-group>
					...
					<el-submenu index="4">
						<template slot="title">
							<div class="menu-op">
								<div>
									<img src="../assets/images/taocan.png" style="width: 18px;height: 18px;"/>
								</div>
							...
							<el-menu-item index="5-1">
								<router-link to="/rpYunYingBaoBiao">
									<div class="menu-op">
										...
										<span class="menu-word">系统报表</span>
									</div>
								</router-link>
							</el-menu-item>
