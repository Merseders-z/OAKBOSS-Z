				...
				<el-col :span="12">
					<el-menu default-active="2" class="el-menu-vertical-demo" background-color="#1e69fe"
						...
						<el-menu-item index="2">
							<router-link to="/carJBjilu">
								<div class="menu-op">
									<div>
										
									</div>
									<span class="menu-word" style="font-size: 14px">停车记录</span>
								</div>
							</router-link>
						</el-menu-item>
						<el-menu-item index="3">
							<router-link to="/carJS">
								<div class="menu-op">
									<div>
										
									</div>
									<span class="menu-word" style="font-size: 14px">捷顺配置</span>
								</div>
							</router-link>
						</el-menu-item>
					</el-menu>
