		...
		<section>
			<template>
				<el-table :data="tableData" stripe style="width: 100%">
					...
					<el-table-column show-overflow-tooltip prop="income" label="收入(/元)">
					</el-table-column>
					<el-table-column show-overflow-tooltip prop="percent" label="分成比例">
					</el-table-column>
		...
		<template>
			...
			<el-dialog title="修改商户账号" :visible.sync="modifyDialogVisible" width="30%">
				<el-form :model="modifyForm" ref="modifyFormRef" label-width="80px">
					...
					<el-form-item label="分成比例" prop="percent">
						<el-input v-model="modifyForm.percent"></el-input>
					</el-form-item>
					<el-form-item label="提现户名" prop="bank_username">
