<template>
	<div class="zyhSingleLineListMainPage">
		<header>
			...
			<div class="searchArea">
				...
				<div class="searchButton">
					<el-button type="primary" icon="el-icon-search" @click.native="searchHandler">
						搜索
					</el-button>
				</div>
				<div class="addButton">
		...
		<section>
			<template>
				<el-table :data="tableData" stripe style="width: 100%">
					...
					<el-table-column show-overflow-tooltip prop="fullname" label="姓名">
					</el-table-column>
					<el-table-column show-overflow-tooltip prop="telephone" label="手机">
					</el-table-column>
					<el-table-column show-overflow-tooltip prop="identity" label="身份证">
					</el-table-column>
					<el-table-column show-overflow-tooltip prop="withdraw_type" label="体现类型" :formatter="formatMerchantType">
					</el-table-column>
					<el-table-column show-overflow-tooltip prop="withdraw_rate" label="手续费">
					</el-table-column>
					<el-table-column show-overflow-tooltip prop="date_created" label="注册时间">
					</el-table-column>
                  ...
                  " @contextmenu.prevent>
									<a href="/#/merchantAccoutDetailPage/basicInformation">
										<div class="wrapper">
											<img src="../../../assets/images/see.png" title="详情" height="11px" />
										</div>
									</a>
								</div>
							</div>
		...
		<template>
			<!-- 添加商户账号 -->
			<el-dialog title="添加商户账号" :visible.sync="addDialogVisible" width="30%" @close="addDialogClosed">
				<el-form :model="addForm" ref="addFormRef" label-width="80px">
					...
					<el-form-item label="手续费" prop="withdraw_rate">
						<el-input v-model="addForm.withdraw_rate"></el-input>
					</el-form-item>
					<el-form-item label="提现户名" prop="bank_username">
						<el-input v-model="addForm.bank_username"></el-input>
					</el-form-item>
					<el-form-item label="提现账户" prop="bank_acccount">
						<el-input v-model="addForm.bank_acccount"></el-input>
					</el-form-item>
					<el-form-item label="提现类型">
						<el-select v-model="addForm.withdraw_type" disabled>
			...
			<!-- 修改商户账号 -->
			<el-dialog title="修改商户账号" :visible.sync="modifyDialogVisible" width="30%">
				<el-form :model="modifyForm" ref="modifyFormRef" label-width="80px">
					...
					<el-form-item label="手续费" prop="withdraw_rate">
						<el-input v-model="modifyForm.withdraw_rate"></el-input>
					</el-form-item>
					<el-form-item label="提现户名" prop="bank_username">
						<el-input v-model="modifyForm.bank_username"></el-input>
					</el-form-item>
					<el-form-item label="提现账户" prop="bank_acccount">
						<el-input v-model="modifyForm.bank_acccount"></el-input>
					</el-form-item>
					<el-form-item label="提现类型">
						<el-select v-model="modifyForm.withdraw_type" disabled>
							<el-option label="支付宝" :value="1"></el-option>
							<el-option label="微信" :value="2"></el-option>
							<el-option label="银行卡" :value="3"></el-option>
						</el-select>
