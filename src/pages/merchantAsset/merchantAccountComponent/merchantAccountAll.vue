		...
		<section>
			<template>
				<el-table :data="tableData" stripe style="width: 100%">
					...
					<el-table-column show-overflow-tooltip prop="type" label="商户类型" :formatter="formatMerchantType">
					</el-table-column>
                  ...
                  " @contextmenu.prevent>
									<a href="/#/merchantAccoutDetailPage/basicInformation">
										<div class="wrapper">
											<img src="../../../assets/images/see.png" title="详情" height="11px" style="cursor: pointer;"/>
										</div>
									</a>
								</div>
							</div>
		...
		<template>
			...
			<el-dialog title="修改商户账号" :visible.sync="modifyDialogVisible" width="30%">
				<el-form :model="modifyForm" ref="modifyFormRef" label-width="80px">
					...
					<el-form-item label="身份证" prop="identity">
						<el-input v-model="modifyForm.identity"></el-input>
					</el-form-item>
				</el-form>
				<span slot="footer" class="dialog-footer">
