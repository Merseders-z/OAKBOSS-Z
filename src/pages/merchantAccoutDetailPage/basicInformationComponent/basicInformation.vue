<template>
	<div class="zyhFormInformationMainDetailPage">
		<header>
			<div class="infoArea">
				...
				<div class="merchantAccoutScan">
					...
					<div class="blank"></div>
					<el-button v-if="merchantValid" @click="validDialogVisible = true">注销按钮</el-button>
					<el-button v-if="!merchantValid" @click="validDialogVisible = true">激活按钮</el-button>
		...
		<el-dialog title="提示" :visible.sync="validDialogVisible" width="30%" :before-close="handleClose">
			...
			<span slot="footer" class="dialog-footer">
				...
				<el-button type="primary" @click="closeDialogAndPutValid">确 定</el-button>
			</span>
		</el-dialog>
	</div>
</template>
