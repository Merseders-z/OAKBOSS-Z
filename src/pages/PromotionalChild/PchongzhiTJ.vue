	...
	<div class="oneCard-right">
		...
		<div class="conB">
			<div class="UserAssets-right-text">
				...
				<div class="whiteBut" @click="daochu">
		...
		<div style="height: 700px;">
			<div style="height: 680px;">
				<div style="margin: 0 auto;width: 90%;text-align: center;margin-top: 200px;font-size: 20px;">暂无信息</div>
	...
	export default {
		...
		methods: {
			...
			daochu(){
				...
				//console.log(toKen)
				if(this.isBg == 1){
					var a = 'http://www.api.sqjtjt.com/admin/api/report/BDD2490598E542E8A8FAE302F25D189C/?token=7b42cf502f5e0ee83c58d6639394f12a&sort=asc&export=csv'
				}else if(this.isBg == 3){
					var a = 'http://www.api.sqjtjt.com/admin/api/report/0906FC695A394B5B8DE1E56DDFEC4F6B/?token=7b42cf502f5e0ee83c58d6639394f12a&sort=asc&export=csv'
				}else if(this.isBg == 5){
					var a = 'http://www.api.sqjtjt.com/admin/api/report/F6C2F765EF4D4250AE23095D7ED3E8D2/?token=7b42cf502f5e0ee83c58d6639394f12a&sort=asc&export=csv'
				}
				window.open(a,'_self')
			},
			daybao(id) {
