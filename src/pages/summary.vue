<template>
	<div class="picture">
		<div class="oakboss">
			<span @click="chooseSF">{{ loginConfig.systemName }}</span>
		...
		<div class="fou">
			<div class="four f" v-show="flag1 == loginConfig.divShow1" @mouseenter.stop="enter" @mouseleave.stop="leave"
				:class="{ show: change }">
			...
			<div class="four f" v-show="flag2 == loginConfig.divShow2" @mouseenter.stop="enter1"
				@mouseleave.stop="leave1" :class="{ show: change1 }">
				...
				<div class="platform" v-show="change1">
					<div @click="to" to="/summary/carCharging" class="platform-money a">
			...
			<div class="four" v-show="flag3 == loginConfig.divShow3" @mouseenter.stop="enter2" @mouseleave.stop="leave2"
				:class="{ show: change2 }">
			...
			<div class="four f" v-show="flag4 == loginConfig.divShow4" @mouseenter.stop="enter3"
				@mouseleave.stop="leave3" :class="{ show: change3 }">
			...
			<div class="four f" v-show="flag5 == loginConfig.divShow5" @mouseenter.stop="enter4"
				@mouseleave.stop="leave4" :class="{ show: change4 }">
			...
			<div class="four" v-show="flag6 == loginConfig.divShow6" @mouseenter.stop="enter5" @mouseleave.stop="leave5"
				:class="{ show: change5 }">
...
<script>
	...
	export default {
		...
		methods: {
			...
			to(){
				console.log(123)
				this.$router.push({path:'/summary/ito'})
			},
			enter() {
				this.change = true;
			},
