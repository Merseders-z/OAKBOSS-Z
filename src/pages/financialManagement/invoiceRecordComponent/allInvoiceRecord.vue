		...
		<section>
			<template>
				<el-table :data="tableData" stripe style="width: 100%">
					...
					<el-table-column show-overflow-tooltip prop="type" :formatter="formatterType" label="类型">
					</el-table-column>
					...
					<el-table-column show-overflow-tooltip prop="created_time" label="创建时间"></el-table-column>
					<el-table-column show-overflow-tooltip prop="delivery_state" :formatter="formatterDeliveryState"
						label="运单状态">
					</el-table-column>
