		...
		<header>
			...
			<div class="searchArea">
				<div class="inputFrame">
					...
					<el-input placeholder="请输入账号、手机号、昵称进行查找" class="inputBlank" v-model="value" clearable></el-input>
				</div>
		...
		<section>
			<template>
				<el-table :data="tableData" stripe style="width: 100%">
					...
					<el-table-column show-overflow-tooltip prop="amount" label="金额(/元)">
					</el-table-column>
					<el-table-column show-overflow-tooltip prop="dev_name" label="关联设备">
					</el-table-column>
					<el-table-column show-overflow-tooltip prop="usage" label="用途">
					</el-table-column>
					<el-table-column show-overflow-tooltip prop="payee_bank_account" label="收款账号">
					</el-table-column>
					<el-table-column show-overflow-tooltip prop="paid_time" label="结算时间">
					</el-table-column>
