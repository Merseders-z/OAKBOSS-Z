		...
		<section>
			<template>
				<el-table :data="tableData" stripe style="width: 100%">
					...
					<el-table-column show-overflow-tooltip prop="after_amout" label="余额">
					</el-table-column>
					<el-table-column show-overflow-tooltip prop="paid_time" label="分成时间">
					</el-table-column>
