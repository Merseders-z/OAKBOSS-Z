	...
	export default {
		...
		methods: {
			...
			daochu(){
				...
				//console.log(toKen)
				if(this.isBg == 1){
					var a = 'http://www.api.sqjtjt.com/admin/api/report/64F7ABE046A84880B8B2213CB03A9259/?token=7b42cf502f5e0ee83c58d6639394f12a&sort=asc&export=csv'
				}else if(this.isBg == 3){
					var a = 'http://www.api.sqjtjt.com/admin/api/report/5205FB66C9C643348FA5C97D1752C839/?token=7b42cf502f5e0ee83c58d6639394f12a&sort=asc&export=csv'
				}else if(this.isBg == 5){
					var a = 'http://www.api.sqjtjt.com/admin/api/report/C2C647A9B5D241638E7FE4033C5A6999/?token=7b42cf502f5e0ee83c58d6639394f12a&sort=asc&export=csv'
				}
				window.open(a,'_self')
			},
			//获取用户卡信息列表
