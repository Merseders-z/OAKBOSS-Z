<template>
	<div class="oneCard-right">
		...
		<div class="wulianBot">
			<div class="wulianBotBox">
				...
				<div class="roadBot" >
					<div class="firstBox">
						...
						<div class="firstBoxBot">{{zhandianNum}}</div>
					</div>
					<div class="rightBox">
							...
							<div class="otherBoxsBot">
								<div  class="otherBoxsBotBox-02">
									<div class="otherBoxsBotBox"> 
										<div class="otherNum">{{dianmozhuangNum}}</div>
									<div class="otherWord">电摩桩总数</div>
									</div>
								</div>
								<div class="otherBoxsBotBox-01">
									<div style="color: white;">电摩桩数量</div>
									<div class="otherNum-02">{{dianmotoManchong}}</div>
									<div class="otherWord">电摩慢充在线数量</div>
								</div>
								<div class="otherBoxsBotBox-1-1">
									<div class="contain-01">
										<el-progress type="circle" color="#20ef73"  :width="105" :show-text="false" :stroke-width="13" :percentage="parseFloat(percentage3())" v-if="!isNaN(parseFloat(percentage4()))"></el-progress>
						...
						<div class="otherBoxs2">
							<div class="otherBoxsBot">
								<div  class="otherBoxsBotBox-02">
									<div class="otherBoxsBotBox"> 
										<div class="otherNum">{{dianmozhanyong}}</div>
									<div class="otherWord">空闲</div>
									</div>
								</div>
								<div class="otherBoxsBotBox-01">
									<div style="color: white;">电摩桩接口</div>
									<div class="otherNum-033">{{dianmozhanyong}}</div>
									<div class="otherWord">占用</div>
								</div>
								<div class="otherBoxsBotBox-1-1">
									<div class="contain-01">
										<el-progress type="circle" color="#20ef73" :width="105" :show-text="false" :stroke-width="15" :percentage="parseFloat(percentage4())" v-if="!isNaN(parseFloat(percentage4()))"></el-progress>
			...
			<div class="wulianBotBoxaaa" v-for="item in dataofMotorcyclecharging">
				<div class="wulianBotBoxT">
					<div class="T_blue"></div>
					...
					.then(res => {
						if(res.status == 200) {
							...
							if(res.data.data.length !==0){
								this.zhandianNum = res.data.data[0].station_type_2_count
								this.dianmozhuangNum = res.data.data[0].charger_type_4_count
								this.dianmotoManchong = res.data.data[0].charger_type_4_count_online
								this.diankongxian = res.data.data[0].charger_type_4_gun
								this.dianmozhanyong = res.data.data[0].charger_type_4_gun_busy
								this.diyigebaifenbi = Math.round(this.dianmotoManchong/this.dianmozhuangNum*100)
								this.shiyonglvgebaifenbi = Math.round(this.dianmozhanyong/this.diankongxian*100)
								console.log(this.diyigebaifenbi,21231)
							}
