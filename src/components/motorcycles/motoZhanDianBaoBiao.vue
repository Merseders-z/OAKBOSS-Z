	...
	export default {
		...
		methods: {
			...
			daochu(){
				...
				//console.log(toKen)
				if(this.isBg == 1){
					var a = 'http://www.api.sqjtjt.com/admin/api/report/D72839B90D7D40A98EE1EEB4E66DE71F/?token=7b42cf502f5e0ee83c58d6639394f12a&sort=asc&export=csv'
				}else if(this.isBg == 3){
					var a = 'http://www.api.sqjtjt.com/admin/api/report/1478065A2844423E8ACE2FFC395356CC/?token=7b42cf502f5e0ee83c58d6639394f12a&sort=asc&export=csv'
				}else if(this.isBg == 5){
					var a = 'http://www.api.sqjtjt.com/admin/api/report/BEDDD2BEF0364BA483794B9BA60D82F6/?token=7b42cf502f5e0ee83c58d6639394f12a&sort=asc&export=csv'
				}
				window.open(a,'_self')
			},
			daybao(id) {
