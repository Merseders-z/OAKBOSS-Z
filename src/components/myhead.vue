			...
			<div class="aside">
				...
				<div :class="{ display: falgs }">
					...
					<div class="touxian">
						...
						<div class="nicheng">
							<span>昵称：<span>{{ fullname }}</span></span>
							<div>个人实名认证</div>
						</div>
					</div>
					<div class="cont">
...
<script>
	...
	export default {
		...
		mounted() {
			...
			this.fullname = JSON.parse(this.admin).fullname
			this.telephone = JSON.parse(this.admin).telephone
			this.creator = JSON.parse(this.admin).creator
