<template>
	<div class="z">
			...
			<div class="main">
				...
				<el-container class="el c">
					<el-main style="overflow-x: hidden">
						<div>
							<el-input @keyup.enter.native="search_stade"
								style="width: 277px; height: 43px; margin: 0 16px 20px 19px" placeholder="请输入内容"
								prefix-icon="el-icon-search" v-model="ser">
							</el-input>
							<el-button style="width: 117px" type="primary" icon="el-icon-plus">添加站点</el-button>
						</div>

						<div class="odd">
							<div class="li" v-for="(item, i) in msg" :key="i" @click="sort(i)">
								...
								<div class="dian" :class="{ display: hidd }" @mouseenter.stop="enter4(i)"
				...
				<el-container class="el">
					<el-header style="font-size: 12px; width: 1000px">
						<div>
							<el-input style="width: 945px; height: 43px; margin: 0 2px 10px 0" placeholder="请输入内容"
								prefix-icon="el-icon-search" v-model="list_text"></el-input>
					...
					<el-main>
						<div class="wen we">
							<span>编号</span><span>名称</span><span>类型</span><span>机号</span><span>状态</span><span>操作</span>
						</div>
						<div class="wen weng" v-for="(item, e) in list_msg" :key="e">
							<span>{{ list_msg[e].dev_id }}</span><span>{{ list_msg[e].dev_id }}</span><span>{{ list_msg[e].type }}</span><span>{{ list_msg[e].mac }}</span><span>
								<img v-if="list_msg[e].online === true" class="im" src="../assets/images/offline.png" />
								<img v-else class="im" src="../assets/images/quxiao.png" /> </span><span
								class="xiaoshou"><img class="im" @click="really(e)" src="../assets/images/shan.png"
									alt="" /><img src="../assets/images/bian.png" alt="" /></span>
						...
						<div class="foot">
							<span>共<span>{{ list_cont }}</span>条信息</span>
							<div class="shu">
								<a class="ab" href="#" @click="list_back"><img src="../assets/images/left.png" /></a>
                  ...
                  parseInt(this.list_cont / 15) + 1
								...
								<a class="ab" href="#"><img src="../assets/images/right.png" /></a>
							</div>
						</div>
					</el-main>
				</el-container>
		...
		<div class="foot_left">
			...
			<div class="shu_left">
				<a class="ab" href="#" @click="back"><img src="../assets/images/left.png" /></a>
          ...
          parseInt(this.cont / 6) + 1
				...
				<a class="ab" href="#" @click="next"><img src="../assets/images/right.png" /></a>
			</div>
		</div>
	</div>
</template>
